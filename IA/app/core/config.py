...
POSTGRE_DB_USER = os.getenv('POSTGRESQL_DEV_USER')
POSTGRE_DB_PASSWORD = os.getenv('POSTGRESQL_DEV_PASSWORD')
POSTGRE_DB_URL = os.getenv('POSTGRESQL_DEV_URL')
POSTGRESQL_DEV_DB = os.getenv('POSTGRESQL_DEV_DB')
